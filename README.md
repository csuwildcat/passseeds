...
- **Private key protection**: The passkey's private key never leaves the authenticator
...
- **Signature isolation**: Each signature is tied to specific challenges, preventing replay attacks
